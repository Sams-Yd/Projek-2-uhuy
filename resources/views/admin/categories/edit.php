    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-slate-900">✏️ Edit Kategori</h1>
                <p class="text-slate-600 mt-2">Ubah informasi kategori produk</p>
            </div>
                ...
                <form action="{{ route('categories.update', $category) }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  class="w-full px-4 py-3 border-2 @error('description') border-red-500 @else border-slate-200 @enderror rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors resize-none">{{ old('description', $category->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18.101 12.93a1 1 0 00-1.414-1.414L10 14.586l-6.687-6.687a1 1 0 00-1.414 1.414l8 8a1 1 0 001.414 0l10-10z" clip-rule="evenodd"></path></svg>
                                {{ $message }}
                    ...
                    <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                        <div class="flex gap-3">
                            <svg class="w-6 h-6 text-blue-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zm-11-1a1 1 0 11-2 0 1 1 0 012 0zM8 9a1 1 0 100-2 1 1 0 000 2zm5-1a1 1 0 11-2 0 1 1 0 012 0z" clip-rule="evenodd"></path></svg>
                            <div>
                                <p class="font-semibold text-blue-900">Informasi</p>
                                <p class="text-sm text-blue-800 mt-1">Kategori ini memiliki <span class="font-bold">{{ $category->products_count ?? 0 }} produk</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3 pt-4 border-t border-slate-200">
                        <button type="submit" class="flex-1 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white font-bold py-3 px-6 rounded-lg transition-all shadow-lg hover:shadow-xl">
